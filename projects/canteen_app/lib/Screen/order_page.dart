...
class DismisableWidget extends StatelessWidget {
  const DismisableWidget({Key? key, required this.child, required this.item}) : super(key: key);
  final Widget child;
  final item;

  @override
  Widget build(BuildContext context) {
    return Dismissible(key: ObjectKey(item), child: child);
  }
}
...
// Row(
// children: [
// Text('Sub-Total',style: GoogleFonts.poppins(fontSize: 14,fontWeight: FontWeight.w500),)
// ],
// )
// ],
// )
